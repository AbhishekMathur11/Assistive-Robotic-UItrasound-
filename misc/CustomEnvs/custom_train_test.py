...
log_dir = os.path.join(os.path.dirname(r"C:\Users\Abhishek Raman\Desktop\Abhishek\IIT Delhi Internship stuff\CustomEnvs\Custom_TargetReaching"), 'logs')
save_model_dir = os.path.dirname(r"C:\Users\Abhishek Raman\Desktop\Abhishek\IIT Delhi Internship stuff\CustomEnvs\Custom_TargetReaching") + "trained_models/ppo/" + "TargetReaching-5e6"
...
if train:
  ...
  model.save(save_model_dir + "/CustomTargetReaching-v0")
...
if test:
  model = PPO.load(save_model_dir + "/CustomTargetReaching-v0")
